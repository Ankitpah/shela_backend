...
module.exports = {
    ...
    EmployersContactLeads: {
        description: 'User manual EmployersLead',
        notes: 'User EmployersLead ',
        tags: ['api', 'users'],
        plugins: {
            'hapi-swagger': {
                responses: {
        ...
        validate: {
            payload: validator.employersContactLead.payload,
            failAction: response.failAction
        }
    },
    EmployeesContactLeads: {
        description: 'User EmployersLead',
        notes: 'User EmployersLead ',
        tags: ['api', 'users'],
        plugins: {
            'hapi-swagger': {
        ...
        validate: {
            payload: validator.employeesContactLead.payload,
            failAction: response.failAction
        }
    },
    checkEmailExists: {
